...
<div class="container-fluid mt-12">
    <table class="table" style="color: #dddddd; border-color: grey">
        ...
        while ($rowPedidos = mysqli_fetch_assoc($resultPedidos)) {
            ...
            echo "<tr>";
            echo "<td style='text-align: center;'><a href='https://rksrodrigues.com/movimentacao.php?idOp={$rowPedidos['idGeral']}' target='_blank' style='color:#dddddd;text-decoration:none;'>" . $rowPedidos['idGeral'] . "</a></td>";            echo '<td>' . $rowPedidos['cliente'] . '</td>';
            echo "<td style='color: $cor2'>" . $status . "</td>";
            echo "<td style='color: $cor1'>" . $situacao . "</td>";
            echo '<td><a href="https://rksrodrigues.com/ajax/enviaEmail.php?idGeral=' . $rowPedidos['idGeral'] . '" class="btn btn-primary">Notificar</a></td>';
