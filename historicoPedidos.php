                      ...
                      <thead style="background-color:#2e2f30">
                        ...
                        //pegando os pedidos do database com base no vendedor logado e o status do pedido
                            ...
                            foreach ($resultSet as $id => $row) {
                               ...
                               $idPedidos = $row['idPedido'];
                               echo("<tr style='height:20px;'>
                                <td scope='row' style='padding:0px;height:20px;font-family: system-ui;'><a href='https://rksrodrigues.com/movimentacao.php?idOp=$idPedidos' target='_blank'>#$idPedidos</a></td>
